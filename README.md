...
1. Stáhni z [Releases](https://github.com/bicalordman/klempcinema/releases) soubor `plugin.video.klempcinema-0.0.178.zip`
...
- `Jack Reacher` ↔ WS `Reacher.SxxExx`
- Hromadné dohledání neúplných sezón (`Reacher S01`…) + cílené SxxEyy
- Dead City filtr franšízy (bez Big City Greens) z 0.0.173/174
...
### v0.0.169 — Seriály: správný picker u epizod

- Picker u epizod filtruje jen soubory daného seriálu (ne cizí SxxEyy)
- U epizod zkrácený název souboru pro rozlišení variant
